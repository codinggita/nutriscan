...
function ProfileStat({ icon: Icon, label, value, sub }) {
  return (
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-[400px] flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <ProfileStat icon={Scale} label="Weight" value={user.weight} sub="kg" />
            <ProfileStat icon={Activity} label="Height" value={user.height} sub="cm" />
          </div>

          {/* Health Conditions Summary */}
          <div className="bg-white border-2 border-gray-900 rounded-[2rem] p-6 shadow-[0_4px_0_0_#111827]">
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4">Medical History</p>
          ...
          <button className="w-full py-3.5 rounded-2xl border-2 border-red-100 font-black uppercase tracking-widest text-red-500 hover:bg-red-500 hover:text-white hover:border-red-500 transition-all flex items-center justify-center gap-2.5 text-xs">
        ...
        <div className="flex-1">
          {meta && <BMIGauge bmi={user.bmi} meta={meta} />}
